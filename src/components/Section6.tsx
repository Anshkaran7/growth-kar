...
export default function Section6({ style }: Section6Props) {
  ...
  return (
    <div
      className={`relative flex items-center justify-center min-h-[60vh] p-8 bg-black text-white ${style}`}
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <div className="absolute -translate-x-12 -translate-y-1 w-1/2 h-auto">
          <Image
        ...
        {/* Overlay Content with Slide Up and Fade Out Effect */}
        {sections.map((section, index) => (
          <div
            key={index}
            className={`absolute right-10 w-1/2 items-end space-x-8 z-10 ${
