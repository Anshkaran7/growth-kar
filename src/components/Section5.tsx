...
export default function Section5({ style }: Section5Props) {
  ...
  return (
    <div
      className={` ${style} scroll-smooth flex items-center justify-center bg-black text-white min-h-screen px-4`}
    >
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl space-y-0 md:space-x-8">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            Service Representator
          </h1>
          <p className=" sm:text-base md:text-xl text-[#666666] text-justify font-semibold">
            Freelancers represent GrowthKAR, not themselves. We provide work
            opportunities based on experience, portfolio, and pricing. Our
            platform has a bidding system where freelancers and service
            providers can bid for work. Alternatively, we can directly choose
            the best-rated freelancers, service providers, or agencies based on
            their portfolio.
          </p>
        </motion.div>
      </div>
